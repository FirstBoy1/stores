...
exports.getStores = async (req, res) => {
  ...
  if (!stores.length && limit) {
    req.flash(
      'info',
      `Hey you asked for page ${page}. But that does't exist. So I put you on page ${pages}`
    );
...
exports.updateStore = async (req, res) => {
  ...
  req.flash(
    'success',
    `Successfully Updated <strong>${store.name}</strong>. <a href="/stores/${store._id}">View Store -></a>`
  );
